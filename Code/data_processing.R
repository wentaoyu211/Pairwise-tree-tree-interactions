...
# BEF-China inventory data of site A and B from 2009-2016
...
##############################################################################
# new structure to exclude invalid data point (undocumented, missing data)
##############################################################################
...
# save BM_data_filter.RData as it is our processed data file
save(BM_data_filter, file = "BM_filter_fileter.RData")
...
match("Nyssa sinensis", sp_level ) # check if sp_name match the number
...
# A_8sp.RData are input data files for stan models
